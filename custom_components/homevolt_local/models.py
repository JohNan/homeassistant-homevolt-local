...
def _add_from_dict_method(cls, from_dict_func):
    """Add a from_dict method to a class."""
    setattr(cls, "from_dict", staticmethod(from_dict_func))


# Add from_dict methods to all dataclasses
def _add_from_dict_methods():
    """Add from_dict methods to all dataclasses."""
    _add_from_dict_method(
        EmsInfo,
        lambda data: EmsInfo(
    ...
    _add_from_dict_method(
        InvConfig,
        lambda data: InvConfig(ffr_fstart_freq=data.get("ffr_fstart_freq", 0)),
    )
    _add_from_dict_method(
        EmsControl,
        lambda data: EmsControl(
    ...
    _add_from_dict_method(EmsDevice, ems_device_from_dict)
...
def _add_from_dict_method(cls, from_dict_func):
    """Add a from_dict method to a class."""
    cls.from_dict = staticmethod(from_dict_func)
